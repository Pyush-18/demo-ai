...
import { selectSalesFilesByCompany } from "../../../../redux/selector/tallySelectors";
import { useNavigate } from "react-router";
import { InvoiceModal } from "../../dashboard/modal/InvoiceModal";

export const SalesPage = ({ company, onBack }) => {
  ...
  const salesFiles = useSelector(
    company ? selectSalesFilesByCompany(company.id) : () => []
  );

  const files = salesFiles.flatMap((file) =>
    ...
    <div className="min-h-screen bg-[#0B0C15] text-slate-300 font-sans selection:bg-fuchsia-500/30">
      ...
      <header className="sticky top-0 z-30 bg-[#0B0C15]/80 backdrop-blur-xl border-b border-white/5 px-8 py-5 flex items-center justify-between">
        ...
        <button
          ...
          className="group flex items-center gap-2 px-5 py-2.5 bg-fuchsia-600 hover:bg-fuchsia-500 text-white rounded-xl font-medium shadow-lg shadow-fuchsia-900/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 mb-8">
          ...
          <div className="relative group flex items-center">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Search
                size={16}
                className="text-gray-500 group-focus-within:text-fuchsia-400 transition-colors"
              />
            </div>
            <input
              type="text"
              ...
              className="block w-full pl-10 pr-4 py-2.5 bg-gray-900/50 border border-gray-800 rounded-xl text-sm text-white placeholder-gray-600 focus:border-fuchsia-500/50 focus:ring-4 focus:ring-fuchsia-500/10 focus:bg-gray-900 transition-all outline-none"
            />
          </div>
          ...
          {filteredFiles.length > 0 ? (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded bg-indigo-500/10 text-indigo-400 group-hover:text-indigo-300 transition-colors">
                            <FileText size={16} />
                          </div>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        <div className="flex items-center gap-2">
                          <div className="w-5 h-5 rounded-full bg-gradient-to-tr from-fuchsia-600 to-purple-600 flex items-center justify-center text-[9px] font-bold text-white">
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-sm text-gray-500 mt-1 max-w-xs mx-auto">
                We couldn't find any files matching your current filters. Try
